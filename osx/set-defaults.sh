...
sudo scutil --set ComputerName "bsima"
sudo scutil --set HostName "bsima"
sudo scutil --set LocalHostName "bsima"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "bsima"
